/* tslint:disable */
/*
* This file generated automaticaly (Mon Feb 18 2019 17:31:26 GMT+0100 (CET))
...
export namespace Protocol {
	...
	* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	export function init(){
		...
		ReferencesMap["58B52DFC"] = Message.GetUsersList;
...
export namespace Message {
	export class Handshake extends Message {
		static getDescription(): {[key: string]: Protocol.IProperty } {
			return {
				...
				error: { name: "error", value: ConnectionError, type: Protocol.EEntityType.reference, optional: true }, 
			}
		}
		...
		constructor(args: { clientId: string, guid?: string, allowed: boolean, error?: ConnectionError }) {
	...
	export class GetUsersList extends Message {
		static getDescription(): {[key: string]: Protocol.IProperty } {
			return {
				clientId: { name: "clientId", value: "asciiString", type: Protocol.EEntityType.primitive, optional: false }, 
				guid: { name: "guid", value: "guid", type: Protocol.EEntityType.primitive, optional: true }, 
		...
		static __signature: string = "58B52DFC";
		static getSignature(): string {
			return GetUsersList.__signature;
		}
		public __signature: string = GetUsersList.__signature;
		public getSignature(): string {
			return this.__signature;
		}
		static parse(str: string | object): Protocol.TTypes | Error {
			return Protocol.parse(str, GetUsersList);
		}
		public stringify(): string {
			return Protocol.stringify(this, GetUsersList) as string;
		}
		public users: Array<User> = [];

		constructor(args: { clientId: string, guid?: string, users: Array<User> }) {
			super(Object.assign(args, {}));
			this.users = args.users;
			const errors: Error[] = Protocol.validateParams(args, GetUsersList);
			if (errors.length > 0) {
				throw new Error(`Cannot create class of "GetUsersList" due error(s):\n${errors.map((error: Error) => { return `\t- ${error.message}`; }).join('\n')}`);
			}
...
export class User extends Protocol.Root {
	static getDescription(): {[key: string]: Protocol.IProperty } {
		return {
			firstname: { name: "firstname", value: "string", type: Protocol.EEntityType.primitive, optional: false }, 
			lastname: { name: "lastname", value: "string", type: Protocol.EEntityType.primitive, optional: false }, 
			email: { name: "email", value: "asciiString", type: Protocol.EEntityType.primitive, optional: false }, 
		}
	}
	static __signature: string = "3B609EF0";
	static getSignature(): string {
	...
	public stringify(): string {
		return Protocol.stringify(this, User) as string;
	}
