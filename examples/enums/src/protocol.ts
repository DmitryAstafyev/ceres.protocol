/* tslint:disable */
/*
* This file generated automaticaly (Sun Feb 17 2019 19:43:39 GMT+0100 (CET))
	...
	export class Handshake extends Message {
		static getDescription(): {[key: string]: Protocol.IProperty } {
			return {
				...
				reason: { name: "reason", value: Message.Handshake.Reasons, type: Protocol.EEntityType.reference, optional: true }, 
		...
		public reason?: Message.Handshake.Reasons;
		public error?: string = "";

		constructor(args: { clientId: string, guid?: string, allowed: boolean, reason?: Message.Handshake.Reasons, error?: string }) {
