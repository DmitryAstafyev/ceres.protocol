...
/* tslint:disable */
/*
* This file generated automaticaly (Sun Feb 17 2019 17:40:01 GMT+0100 (CET))
...
(function (Protocol) {
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    function init() {
        Protocol.ReferencesMap["3B609EF0"] = User;
...
class User extends Protocol.Root {
    constructor(args) {
        super();
        this.__signature = User.__signature;
        this.firstname = "";
        this.lastname = "";
        this.email = "";
        ...
        const errors = Protocol.validateParams(args, User);
        if (errors.length > 0) {
    ...
    static getDescription() {
        return {
            ...
            email: { name: "email", value: "email", type: Protocol.EEntityType.primitive, optional: false },
        };
    }
    static getSignature() {
...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
Protocol.init();
//# sourceMappingURL=protocol.advanced.js.map